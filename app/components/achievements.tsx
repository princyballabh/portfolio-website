...
const achievements: Achievement[] = [
  ...
  },
  {
    ...
    description: "Recognized as a super contributor for significant open source contributions during Hacktoberfest.",
    details: [
      "Multiple PR merges",
  ...
  },
  {
    ...
    links: [
      ...
      { label: "CodeChef", url: "https://www.codechef.com/users/princyballabh" },
      { label: "GeeksforGeeks", url: "https://www.geeksforgeeks.org/profile/princyballabh13" },
    ],
  },
  {
    id: 4,
  ...
  return (
    <section className="relative py-12 md:py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          className="h-1 w-32 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full mx-auto mb-16"
          initial={{ width: 0 }}
